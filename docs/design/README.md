...
| 组件 | 作用 | 状态 | 关键依赖 |
| --- | --- | --- | --- |
| [运行平台与基础配置](components/platform-runtime.md) | 固定 Minecraft、NeoForge 与 Java 运行基线 | active | Minecraft 1.21.1、NeoForge 21.1.235、Java 21 |
| [调研报告：长线运营方案](research-report-v1.md) | 1.21.1 NeoForge 生态调研、魔改框架选型、版本更新机制设计 | completed | KubeJS 7.0、Chapters、FTB 生态 |
| [Sodium](components/sodium.md) | 渲染引擎优化，提升帧率与减少卡顿 | active | CLIENT；与 Embeddium 不兼容 |
| [Lithium](components/lithium.md) | 游戏逻辑与物理模拟优化 | active | BOTH |
| [ImmediatelyFast](components/immediatelyfast.md) | 立即模式渲染批处理优化 | active | CLIENT |
| [Iris](components/iris.md) | 着色器模组，兼容 OptiFine 着色器包 | active | CLIENT；与 Embeddium 不兼容 |
| [ModernUI](components/modernui.md) | 现代化 UI 框架与字体渲染 | active | BOTH |
| [JEI](components/jei.md) | 物品与配方查看 | active | CLIENT；KubeJS 可选集成 |
| [Jade](components/jade.md) | 方块与实体信息提示（Hwyla 分支） | active | BOTH；KubeJS 可选集成 |
| [KubeJS](components/kubejs.md) | 脚本系统，自定义配方、事件、内容 | active | BOTH；依赖 Rhino |
| [KubeJS Additions](components/kubejsadditions.md) | KubeJS 扩展功能，补充事件与 API | active | BOTH；依赖 KubeJS |
| [Rhino](components/rhino.md) | Mozilla Rhino JS 运行时，KubeJS 核心依赖 | active | BOTH |
| --- | --- | --- | --- |
| [运行平台与基础配置](components/platform-runtime.md) | 固定 Minecraft、NeoForge 与 Java 运行基线 | active | Minecraft 1.21.1、NeoForge 21.1.235、Java 21 |
| [调研报告：长线运营方案](research-report-v1.md) | 1.21.1 NeoForge 生态调研、魔改框架选型、版本更新机制设计 | completed | KubeJS 7.0、Chapters、FTB 生态 |
